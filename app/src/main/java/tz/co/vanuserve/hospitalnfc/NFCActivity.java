...
import tz.co.vanuserve.hospitalnfc.fragments.NFCReadFragment;
import tz.co.vanuserve.hospitalnfc.fragments.NFCWriteFragment;
...
public class NFCActivity extends AppCompatActivity implements Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(actionBar!=null){
            actionBar.setTitle("Read/Write NFC");
        }
